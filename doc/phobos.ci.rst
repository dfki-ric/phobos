...
.. toctree::
    ...
    phobos.ci.model
    phobos.ci.combined_model
    phobos.ci.xtype_model
    phobos.ci.test_model
...
```````````````````
.. automodule:: phobos.ci.test_model
    :members:
    :undoc-members:
    :show-inheritance:
...
```````````````````
.. automodule:: phobos.ci.compare_model
    :members:
    :undoc-members:
    :show-inheritance:
...
```````````````````
.. automodule:: phobos.ci.model_testing
    :members:
    :undoc-members:
    :show-inheritance:
