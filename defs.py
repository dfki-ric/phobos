...
defaultmaterials = {
    ...
    'phobos_inertial': {'diffuse': (1, 0.18, 0), 'specular': (1, 1, 1), 'alpha': 0.3, 'diffuse_intensity': 0.7},
    'phobos_sensor': {'diffuse': (0.8, 0.75, 0), 'specular': (1, 1, 1), 'alpha': 0.3, 'diffuse_intensity': 0.7},
